...
from environment.envs.UGV2.UGVForward import UGV_Forward as env
...
if __name__ == '__main__':
    ...
    if TRAIN:
        ...
        '''2. 定义 DPPO 及其基本参数'''
        process_num = 6
        actor_lr = 3e-4 / min(process_num, 10)
        critic_lr = 1e-3 / min(process_num, 10)  # 一直都是 1e-3
        action_std = 0.9
        k_epo = int(100 / process_num * 1.0)  # int(100 / process_num * 1.1)
        ...
        agent.global_policy.load_state_dict(torch.load('Policy_PPO5700'))
