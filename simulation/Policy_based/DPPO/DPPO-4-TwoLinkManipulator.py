...
from environment.envs.RobotManipulators.TwoLinkManipulator import TwoLinkManipulator as env
...
if __name__ == '__main__':
    ...
    if TRAIN:
        ...
        agent.global_policy.load_state_dict(torch.load('../../../datasave/network/DPPO-4-TwoLinkManipulator'
                                                       '/Policy_PPO49800'))
