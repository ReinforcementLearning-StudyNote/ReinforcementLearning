...
cfgFile = 'UGV_Forward_Continuous_Path_Follow.xml'
...
if __name__ == '__main__':
    simulationPath = '../../datasave/log/' + datetime.datetime.strftime(datetime.datetime.now(), '%Y-%m-%d-%H-%M-%S') + '-DDPG-UGV-Forward-Path-Follow/'
